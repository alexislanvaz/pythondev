...
<body oncontextmenu='return false' class='snippet-body'>
    <img src="./images/logo1.jpg" class="rounded float-start img-responsive ml-lg-5" alt="..." width="200"
        style="border-left: 39px;">
    <img src="./images/logo2.jpg" class="rounded float-end img-responsive mr-lg-5" alt="..." width="200" height="90">
        ...
        <form class="pt-3">
            ...
            <div class="text-center pt-3 text-muted">
                <div class="text-center p-md-2">
                    <button
                        type="button" class="rainbow-button" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">Instrucciones</button>
                    </div>
            </div>

        </form>
    </div>
    <img src="./images/logo3.png" class="rounded mx-auto d-block" alt="" width="200" height="90">
